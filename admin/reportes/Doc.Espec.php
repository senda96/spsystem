...
class PDF extends FPDF 
	{
		function AcceptPageBreak()
		{
			...
			$this->SetX(30);
			$this->Cell(70,6,'ESPECIALIDAD',1,0,'C',1);
			$this->SetX(100);
			$this->Cell(70,6,'CANTIDADS',1,0,'C',1);
			$this->Ln();
		}
		...
		function Header()
		{
			...
			$this->Cell(50);
			$this->Cell(105,10,'Cantidad de Doctores por Especialidad',1,0,'C',1);
			$this->Ln(30);
		}
	...
	$pdf->SetX(30);
	$pdf->Cell(70,6,'ESPECIALIDAD',1,0,'C',1);
	$pdf->SetX(100);
	...
	foreach($datos as $fila)
	{
		...
		$pdf->SetX(30);
		$pdf->Cell(70,6, utf8_decode($fila['Especialidad']),1,0,'C');
		$pdf->SetX(100);
