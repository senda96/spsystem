...
?>	
	<?php
	$sql = "SELECT * from pacientes, diagnosticos, reservaciones where diagnosticos.cod_reservacion = reservaciones.cod_reservacion and reservaciones.cod_pac = pacientes.cod_pac and estado!='Negada' and estado!='Atendida' and cod_user = ?  order by fecha desc ";
